...
"""
Projector and eye tracker configuration for Prisma MRI ONLY.
Add this file to the experiment directory and then import it into the experiment script:
    import Prisma_config_x as room_config
        where x is the version of Prisma_config_*.py to import.
...
def ApplyMonitorConfig():
    ...
    gammGrid=[[9.618,543.2,2.2263,9.618,0.0057,16.7018],[9.618,61.04,2.3341,9.618,0.0072,5.4],[9.618,138.6,2.2673,9.6177,0.0265,8.5059],[9.618,21.05,2.3292,9.618,0.0071,2.7903]]
    ...
    my_monitor.setWidth(56.0)
    my_monitor.setDistance(107.5)
...
def ApplyEyeLinkDefaults():
    ...
    # Display PC settings
    el_tracker.sendCommand('screen_distance = 1040 1110') # Eye to screen top/bottom distances.
    ...
    el_tracker.sendCommand('calibration_area_proportion 0.50 0.70') # Reduce point spread.
    el_tracker.sendCommand('validation_area_proportion 0.50 0.70') # Reduce point spread.
