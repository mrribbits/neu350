...
"""
Nordic and eye tracker configuration for Prisma MRI ONLY.
...
def ApplyMonitorConfig():
    ...
    gammGrid=[[0.6080,206.8,2.0907,0.608,0.0041,12.8039],[0.608,46.48,2.0815,0.6070,0.0361,6.2749],[0.608,140,2.1417,0.6079,0.0101,10.0289],[0.6080,17.91,3.0693,0.533,0.4287,2.1082]]
    ...
    my_monitor.setWidth(87.8112)
    my_monitor.setDistance(154)
    my_monitor.setGammaGrid(gammGrid)
    my_monitor.setPsychopyVersion("2025.2.4")
    ...
    my_monitor.setNotes("Nordic Screen")
    ...
    print("Psychopy version: ", my_monitor.getPsychopyVersion())
...
def ApplyEyeLinkDefaults():
    ...
    # Display PC settings
    el_tracker.sendCommand('screen_distance = 1542.5 1580') # Eye to screen top/bottom distances.
